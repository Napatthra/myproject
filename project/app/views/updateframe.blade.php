...
<div align="center"><h3 ><font color="red">UPDATE &nbsp;&nbsp;FRAME</font></h3><br>
<form action="updateframe" method="post" enctype="multipart/form-data">
<div class=" col-lg-6">
  Latitude1:<input type="text" name="lat_from"></div>
  <div class=" col-lg-6">Longtitude1:<input type="text" name="lng_from"></div>
    <br><br>
<div class=" col-lg-6">
  Latitude2:<input type="text" name="lat_to"></div>
  <div class=" col-lg-6">Longtitude2:<input type="text" name="lng_to"></div>
    <br>

    <br><br><input type="submit" value="UPDATE" class="btn btn-success" >
</form>
</div>
</div>
